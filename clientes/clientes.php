...
<form action="insert_clientes.php" method="POST">
    ...
    <input type="text" name="id" placeholder="ID Cliente" pattern="[A-Za-zÁ-Úá-úÑñ0-9 ]+" required>

    <label>Nombre</label>
    <input type="text" name="nombre" placeholder="Nombre Cliente" pattern="[A-Za-zÁ-Úá-úÑñ ]+" required>

    <label>Apellido</label>
    <input type="text" name="apellido" placeholder="Apellido Cliente" pattern="[A-Za-zÁ-Úá-úÑñ ]+" required>

    <label>Tipo cliente</label>
    <div style="margin-bottom:10px;">
        <input type="radio" name="tipo_cliente" value="persona natural" required> Persona natural 
        <input type="radio" name="tipo_cliente" value="empresa"> Empresa
    </div>

    <label>Teléfono</label>
    <input type="tel" name="telefono" placeholder="Incluya código del país" required>
